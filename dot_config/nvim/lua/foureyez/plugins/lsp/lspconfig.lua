return {
	...
	config = function()
		...
		local on_attach = function(client, bufnr)
			...
			vim.keymap.set("n", "gd", "<cmd>Lspsaga goto_definition<CR>", opts) -- show lsp definitions
			...
			vim.keymap.set("n", "<leader>rn", "<cmd>Lspsaga rename ++project<CR>", opts) -- smart rename
			...
			vim.keymap.set("n", "<leader>dk", "<cmd>Lspsaga diagnostic_jump_next<CR>", opts) -- jump to previous diagnostic in buffer

			opts.desc = "Go to next diagnostic"
			vim.keymap.set("n", "<leader>dj", "<cmd>Lspsaga diagnostic_jump_prev<CR>", opts) -- jump to next diagnostic in buffer
